...
CREATE TABLE `reactions` (
  ...
  KEY `user_by` (`user_by`),
  KEY `user_to` (`user_to`),
  CONSTRAINT `reactions_ibfk_1` FOREIGN KEY (`user_by`) REFERENCES `users` (`id`),
  CONSTRAINT `reactions_ibfk_2` FOREIGN KEY (`user_to`) REFERENCES `users` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subscriptions` (
  ...
  CONSTRAINT `subscriptions_ibfk_2` FOREIGN KEY (`subscription_plan_id`) REFERENCES `subscription_plans` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'takeme_service'
--
